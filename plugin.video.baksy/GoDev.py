...
def Fix_Special(url):
    dialogprocess.create("Baksy IPTV","Renaming paths...",'', 'Please Wait')
...
def Archive_File(sourcefile, destfile):
    ...
    for_progress = []
    ITEM =[]
    dialogprocess.create("Baksy IPTV","Archiving...",'', 'Please Wait')
...
def Destroy_Path(path):
    dialogprocess.create("Baksy IPTV ","Cleaning...",'', 'Please Wait')
