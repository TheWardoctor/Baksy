...
f = xbmcvfs.File('special://profile/addon_data/script.baksy.guide/favourites.xml')
data = f.read()
f.close()
if not data:
    f = xbmcvfs.File('special://home/addons/script.baksy.guide/resources/favourites.xml')
    data = f.read()
    f.close()
