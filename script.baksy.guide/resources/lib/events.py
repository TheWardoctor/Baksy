...
path = xbmc.translatePath('special://home/addons/script.baksy.guide/resources/eventList.txt')
f = open(path, 'r+')
f.truncate()
#os.remove(path)
...
def Baksy IPTV GuideINFO():
    eventList = xbmc.translatePath('special://home/addons/script.baksy.guide/resources/eventList.txt')
