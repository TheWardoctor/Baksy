...
url        = source + 'SF.zip'
path       = xbmc.translatePath('special://home/userdata/addon_data/script.baksy.guide')
...
localtxt01 = 'Install'
localtxt02 = 'Downloading Latest Baksy IPTV Guide Super Favourites...'
...
if __name__ == '__main__':
	...
	try:
		...
		xbmc.executebuiltin('Notification(Install Failed, Is Super Favourites installed?,special://home/addons/script.baksy.guide/icon.png)')
	time.sleep(1)


os.remove(path + "/SF.zip")
xbmc.executebuiltin('Notification(Super Favs Folders, Updated,special://home/addons/script.baksy.guide/icon.png)')
time.sleep(1)